...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Закрий ноут\PycharmProjects\pythonProject4\env'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Закрий ноут\PycharmProjects\pythonProject4\env\Scripts\deactivate.nu'
